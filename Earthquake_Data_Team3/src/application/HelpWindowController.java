...
public class HelpWindowController {
	...
	public void closeButtonAction(ActionEvent event) {
		//when the close button is clicked it closes the window
	...
	public void initialize() {
		//this gives our help text to the user
		...
		text += "Search: To search by a criteria, select a variable from the drop down and add two criteria. For example, "
				...
				+ "if there is no range and you are only checking to see if it is equal, enter it in the 'min' box."
		...
		text += "Convert entire set to text file: Use this button to create a text file (.txt) output with all entries in the data. \n \n";
